...
# -*- coding: utf-8 -*-
"""
MNIST interpretable classification using prototypes.
...
n_prototypes_array = [15, 10, 9, 7, 6, 5, 4, 3, 2, 1]
...
for n_prototypes in n_prototypes_array:
  # the directory to save the model
  model_folder = os.path.join(os.getcwd(), "saved_model", "mnist_model", "mnist_cae_" + str(n_prototypes) + "prototypes")
